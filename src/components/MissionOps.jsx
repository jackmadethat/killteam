    ...
    <div className="sectionContent" id="gameSequence">
      ...
      <div className="missionGrid">
        ...
        <table className="killOptable">
          ...
          <tbody>
            <tr>
              <td rowspan="10">Starting Number of Enemy Operatives</td>
              <td data-row="1" role="button">5</td>
              <td data-row="1" role="button">1</td>
              <td data-row="1" role="button">2</td>
              <td data-row="1" role="button">3</td>
              <td data-row="1" role="button">4</td>
              <td data-row="1" role="button">5</td>
            </tr>
            <tr>
              <td data-row="2" role="button">6</td>
              <td data-row="2" role="button">1</td>
              <td data-row="2" role="button">2</td>
              <td data-row="2" role="button">4</td>
              <td data-row="2" role="button">5</td>
              <td data-row="2" role="button">6</td>
            </tr>
            <tr data-row="3">
              <td data-row="3" role="button">7</td>
              <td data-row="3" role="button">1</td>
              <td data-row="3" role="button">3</td>
              <td data-row="3" role="button">4</td>
              <td data-row="3" role="button">6</td>
              <td data-row="3" role="button">7</td>
            </tr>
            <tr data-row="4">
              <td data-row="4" role="button">8</td>
              <td data-row="4" role="button">2</td>
              <td data-row="4" role="button">3</td>
              <td data-row="4" role="button">5</td>
              <td data-row="4" role="button">6</td>
              <td data-row="4" role="button">8</td>
            </tr>
            <tr data-row="5">
              <td data-row="5" role="button">9</td>
              <td data-row="5" role="button">2</td>
              <td data-row="5" role="button">4</td>
              <td data-row="5" role="button">5</td>
              <td data-row="5" role="button">7</td>
              <td data-row="5" role="button">9</td>
            </tr>
            <tr data-row="6">
              <td data-row="6" role="button">10</td>
              <td data-row="6" role="button">2</td>
              <td data-row="6" role="button">4</td>
              <td data-row="6" role="button">6</td>
              <td data-row="6" role="button">8</td>
              <td data-row="6" role="button">10</td>
            </tr>
            <tr data-row="7">
              <td data-row="7" role="button">11</td>
              <td data-row="7" role="button">2</td>
              <td data-row="7" role="button">4</td>
              <td data-row="7" role="button">7</td>
              <td data-row="7" role="button">9</td>
              <td data-row="7" role="button">11</td>
            </tr>
            <tr data-row="8">
              <td data-row="8" role="button">12</td>
              <td data-row="8" role="button">2</td>
              <td data-row="8" role="button">5</td>
              <td data-row="8" role="button">7</td>
              <td data-row="8" role="button">10</td>
              <td data-row="8" role="button">12</td>
            </tr>
            <tr data-row="9">
              <td data-row="9" role="button">13</td>
              <td data-row="9" role="button">3</td>
              <td data-row="9" role="button">5</td>
              <td data-row="9" role="button">8</td>
              <td data-row="9" role="button">10</td>
              <td data-row="9" role="button">13</td>
            </tr>
            <tr data-row="10">
              <td data-row="10" role="button">14</td>
              <td data-row="10" role="button">3</td>
              <td data-row="10" role="button">6</td>
              <td data-row="10" role="button">8</td>
              <td data-row="10" role="button">11</td>
              <td data-row="10" role="button">14</td>
            </tr>
          </tbody>
        </table>
