    ...
    <div className="sectionContent" id="gameSequence">
      ...
      <div className="missionGrid">
        <div className="missionOp">
          <h3 className="opTitle">1 - SECURE</h3>
        ...
        <div className="missionOp">
          <h3 className="opTitle">2 - LOOT</h3>
          <h3 className="opSubHeading">MISSION ACTION</h3>
          <div className="actionLine"></div>
          <div className="actionDiv">
              <div className="titleBlock">
        ...
        <div className="missionOp">
          <h3 className="opTitle">3 - TRANSMISSION</h3>
          <h3 className="opSubHeading">MISSION ACTION</h3>
          <div className="actionLine"></div>
          <div className="actionDiv">
              <div className="titleBlock">
        ...
        <div className="missionOp">
          <h3 className="opTitle">4 - UPLOAD</h3>
          <h3 className="opSubHeading">MISSION ACTION</h3>
          <div className="actionLine"></div>
          <div className="actionDiv">
              <div className="titleBlock">
        ...
        <div className="missionOp">
          <h3 className="opTitle">5 - INTEL</h3>
          <h3 className="opSubHeading">MISSION ACTION</h3>
          <div className="actionLine"></div>
          <div className="actionDiv">
              <div className="titleBlock">
        ...
        <div className="missionOp">
          <h3 className="opTitle">6 - EXTRACTION</h3>
          <h3 className="opSubHeading">MISSION ACTION</h3>
          <div className="actionLine"></div>
          <div className="actionDiv">
              <div className="titleBlock">
        ...
        <div className="missionOp">
          <h3 className="opTitle">7 - SABOTAGE</h3>
          <h3 className="opSubHeading">MISSION ACTION</h3>
          <div className="actionLine"></div>
          <div className="actionDiv">
              <div className="titleBlock">
        ...
        <div className="missionOp">
          <h3 className="opTitle">8 - POWER SURGE</h3>
          <h3 className="opSubHeading">MISSION ACTION</h3>
          <div className="actionLine"></div>
          <div className="actionDiv">
              <div className="titleBlock">
        ...
        <div className="missionOp">
          <h3 className="opTitle">9 - COORDINATES</h3>
          <h3 className="opSubHeading">MISSION ACTION</h3>
          <div className="actionLine"></div>
          <div className="actionDiv">
              <div className="titleBlock">
