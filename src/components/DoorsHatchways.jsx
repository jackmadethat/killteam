function DoorsHatchways() {
  return (
    <div className="sectionContent" id="doors">
        ...
        <p className="indentNote"><em>This action allows an operative to fight across an open door/hatchway — useful if the enemy is obstructing it and preventing your operatives from moving through.</em></p>
