function DoorsHatchways() {
  return (
    <div className="sectionContent" id="doors">
        ...
        <p>1APL</p>
        <ul>
            <li><img src="./src/img/yes.svg" className="svgImg" />Open or close a door/hatchway that’s access point is within the operative’s control range.</li>
            <li><img src="./src/img/yes.svg" className="svgImg" />An operative can perform this action during a <b>Dash</b> or <b>Reposition</b> action, and any remaining move distance can be used after it does so.</li>
            <li><img src="./src/img/no.svg" className="svgImg" />An operative cannot perform this action while within control range of an enemy operative, or if that door/hatchway is open and its access point is within an enemy operative’s control range.</li>
        </ul>
        ...
        <figure>
            <img src="./src/img/walls-hatchway-1.png" className="imgGraphic" />
            <p>Closed</p>
        ...
        <figure>
            <img src="./src/img/walls-hatchway-2.png" className="imgGraphic" />
            <p>Open</p>
        ...
        <ul>
            <li>
                <img src="./src/img/yes.svg" className="svgImg" /> Fight with the active operative
            </li>
            <li>
                <img src="./src/img/yes.svg" className="svgImg" /> In the Select Enemy Operative step, instead select an enemy operative within 2” of, and on the other side of, an open door/hatchway’s access point the active operative is touching. For the duration of that action, those operatives are treated as being within each other’s control range.
            </li>
            <li>
                <img src="./src/img/no.svg" className="svgImg" /> This action is treated as a <b>Fight</b> action. An operative cannot perform this action while within control range of an enemy operative, or if its base isn’t touching an open door/hatchway’s access point.
            </li>
        </ul>
        ...
        <figure>
            <img src="./src/img/hatchwayfight-example-1.png" className="imgGraphic" />
