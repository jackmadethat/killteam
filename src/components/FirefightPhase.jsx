function FirefightPhase() {
  return (
    <div className="sectionContent" id="firefightPhase">              
      ...
      <div>
          <div>1. Determine order</div>
          <div>→</div>
          <div>2. Perform actions</div>
      </div>
      <p><em>Repeat until all operatives are expended</em></p>
      <div>
          <div>Next player activates</div>
          <div>→</div>
          <div>3. Expended</div>
      </div>
      <p><em>Are all your operatives expended, but not your opponent’s? <b>Counteract</b>.</em></p>
      ...
      <p><em>Giving your operatives the right order is key. As you play a few games, you’ll gain a greater understanding of when to use an Engage order and when to use a Conceal order.</em></p>
      ...
      <p><em>Example: an operative with APL 2 could <b>Reposition</b> (1AP) and <b>Shoot</b> (1AP), totalling 2AP; but couldn’t <b>Fall Back</b> (2AP) and <b>Shoot</b> (1AP), which totals 3AP.</em></p>
      <h3>Expended</h3>
      <ul>
      ...
      <p><em>An order token with the darker side up shows an operative as expended.</em></p>
      <h3>Counteract</h3>
      ...
      <p><em>Counteracting isn’t an activation, it’s instead of activating. This difference is important; for instance, it means action restrictions won’t apply.</em></p>
    </div>
  )
}
