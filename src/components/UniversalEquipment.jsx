function UniversalEquipment() {
  return (
    <div className="sectionContent" id="universalEquipment">
        ...
        <h3>1x Ammo Cache</h3>
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/ammo-cache.png" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px' }} />
        ...
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/comms-device.png" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px' }} />
        ...
        <h3>1x Mines</h3>
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/mines.png" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px' }} />
        ...
        <h3>1x Razor Wire</h3>
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/razor-wire.png" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px' }} />
        ...
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/light-barricade.png" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px' }} />
        ...
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/heavy-barricade.png" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px' }} />
        ...
        <h3>2x Ladders</h3>
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/ladder.png" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px' }} />
        ...
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/portable-barricade.png" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px' }} />
