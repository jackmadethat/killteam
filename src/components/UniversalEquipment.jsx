const UniversalEquipment = () => {
  return (
    <div className="sectionContent" id="universalEquipment">
        ...
        <h3>Ammo Cache</h3>
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/equipment/Equipment_AmmoCache.svg" className="imgGraphic roundToken" />
        ...
        <div className="actionDiv">
            ...
            <ul>
                <li><img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/icons/yes.svg" className="svgImg" /> One of your Ammo Cache markers the active operative controls is used this turning point.</li>
                <li><img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/icons/yes.svg" className="svgImg" /> Until the start of the next turning point, whenever this operative is shooting with a weapon from its datacard, you can re-roll one of your attack dice.</li>
                <li><img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/icons/no.svg" className="svgImg" /> An operative cannot perform this action while within control range of an enemy operative, if that marker isn’t yours, or if that marker has been used this turning point.</li>
            </ul>
        </div>
        
        <h3>Comms Device</h3>
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/equipment/Equipment_CommsDevice.svg" className="imgGraphic roundToken" />
        ...
        <div className="actionDiv">
            ...
            <ul>
                <li><img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/icons/yes.svg" className="svgImg" /> The same as the <b>Reposition</b> action, except the active operative can move no more than its Move stat minus 2" and cannot climb, drop, jump or use any kill team's rules that remove it and set it back up again.</li>
                <li><img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/icons/yes.svg" className="svgImg" /> Before this operative moves, remove the portable barricade it is connected to. After the operative moves, set up the portable barricade so that it is once again connected to the operative, but the portable barricade cannot be set up within 2" of other equipment terrain features, access points or accessible terrain. If this is not possible, the portable barricade is not set up again.</li>
                <li><img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/icons/no.svg" className="svgImg" /> This action is treated as a <b>Reposition</b> action. An operative cannot perform the <b>Move with Barricade</b> action in the same turning point in which it performed the <b>Fall Back</b> or <b>Charge</b> actions.</li>
            </ul>
        </div>
