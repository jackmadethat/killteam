const Introduction = () => {
  return (
    <div className="sectionContent" id="introduction">
      ...
      <p>The game is originally designed for Warhammer 40k miniatures, but any miniatures are fine as long as they comply with Kill Team Rules (base sizes, for example).</p>
