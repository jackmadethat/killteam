function TerrainRules() {
  return (
    <div className="sectionContent" id="terrainRules">
        <h3>Key Reference</h3>
        <figure>
            <img src="./src/img/gallowdark-esceno.png" className="imgGraphic" />
        </figure>
        <div>Bheta-Decima</div>
        ...
        <figure>
            <img src="./src/img/gantry-example-1.png" className="imgGraphic" />
        </figure>
        ...
        <figure>
            <img src="./src/img/condenser-example-1.png" className="imgGraphic" />
        </figure>
        ...
        <p><em>Lurking predators stop operatives from venturing too close to the ocean, while strong currents and toxic water prevent them from entering it.</em></p>
        ...
        <p><em>Relentless waves, sea mist, and industrial smog make it harder for operatives to see targets over the ocean’s surface.</em></p>
        <figure>
            <img src="./src/img/targeting-example-1.png" className="imgGraphic" />
            <p>In both cases, use targeting lines to determine if a hazardous area or the footprint of a gantry is between them.</p>
            <p><em>Restricted targeting only matters if one or more of the operatives in question are on the killzone floor; if they are both on Vantage terrain, it has no effect.</em></p>
        </figure>
        <figure>
            <img src="./src/img/targeting-example-2.png" className="imgGraphic" />
            <p>A gantry’s footprint is the gantry itself, plus the area underneath it.</p>
        </figure>
        <figure>
            <img src="./src/img/targeting-example-3.png" className="imgGraphic" />
        ...
        <figure>
            <img src="./src/img/targeting-example-4.png" className="imgGraphic" />
        ...
        <figure>
            <img src="./src/img/stronghold-example-1.png" className="imgGraphic" />
        </figure>
        <figure>
            <img src="./src/img/stronghold-example-2.png" className="imgGraphic" />
        </figure>
        <h3>Large Ruin</h3>
        <ul>
        ...
        <figure>
            <img src="./src/img/largeruin-example-1.png" className="imgGraphic" />
        </figure>
        <h3>Small Ruin</h3>
        <p>This is Heavy terrain.</p>
        <figure>
            <img src="./src/img/smallruin-example-1.png" className="imgGraphic" />
        </figure>
        <h3>Heavy Rubble</h3>
        <p>This is Heavy terrain.</p>
        <figure>
            <img src="./src/img/heavyrubble-example-1.png" className="imgGraphic" />
        </figure>
        <h3>Light Rubble</h3>
        <p>This is Light terrain.</p>
        <figure>
            <img src="./src/img/lightrubble-example-1.png" className="imgGraphic" />
        </figure>
        <h3>Cityfight</h3>
        <p>Killzone: Volkus has the following additional rules.</p>
        ...
        <p><em>The Condensed Stronghold rule always relates to the target’s location, so if the primary target is wholly within a stronghold, but the secondary target isn’t, then this rule doesn’t apply to that secondary target.</em></p>
        ...
        <figure>
            <img src="./src/img/tomb-world-walls-1.png" className="imgGraphic" />
        </figure>
        <figure>
            <img src="./src/img/tw-walls-example-1.png" className="imgGraphic" /> Operative A would usually be within 3” of operative B, but as distances cannot be measured over or through Wall terrain, it must be measured around the Tomb World wall. This would make operative A more than 3” from operative B.
        </figure>
        <figure>
            <img src="./src/img/tw-walls-example-2.png" className="imgGraphic" /> Operative B is not in cover as a corner or end of the wall is not intervening. Note that minor parts of the wall that protrude do not make a corner or end alone; it must be the main structure of the wall that turns a corner or ends, as shown in the following diagrams.
        </figure>
        <figure>
            <img src="./src/img/tw-walls-example-3.png" className="imgGraphic" /> A corner of the wall is intervening, therefore operative B is in cover.
        </figure>
        <figure>
            <img src="./src/img/tw-walls-example-4.png" className="imgGraphic" /> Operative A has passed the corner of the wall, therefore it’s not intervening and operative B is not in cover. Note that if operative A was wholly on the left side of the dotted black line, the wall would be intervening and operative B would be in cover.
        </figure>
        <figure>
            <img src="./src/img/tw-walls-example-5.png" className="imgGraphic" /> An end of the wall is intervening, therefore operative B is in cover.
        </figure>
        <figure>
            <img src="./src/img/tw-walls-example-6.png" className="imgGraphic" /> As the hatchway is open, an end of the wall is intervening. It’s more than 1” from both operatives, therefore operative B is obscured.
        </figure>
        <h3>Breach Point</h3>
        ...
        <p>2APL</p>
        <ul>
            <li><img src="./src/img/yes.svg" className="svgImg" /> Open a closed breach point thats access point is within the operative’s control range.</li>
            <li><img src="./src/img/yes.svg" className="svgImg" /> An operative that has the word(s) “breach marker”, “grenadier” or “mine” on its datacard, or has a weapon with the Piercing 2 or Piercing Crits 2 weapon rule (excluding weapons that have the Blast or Torrent weapon rule) can perform this action for 1 less AP (to a minimum of 1AP), but it cannot do so during an activation/counteraction in which it performed the Charge or Shoot action (or vice versa).</li>
            <li><img src="./src/img/yes.svg" className="svgImg" /> Roll one D6 separately for each operative that’s on the other side of the access point and has that access point within its control range: on a 4+, subtract 1 from that operative’s APL stat until the end of its next activation and inflict damage on it equal to the dice result halved (rounding up).</li>
            <li><img src="./src/img/no.svg" className="svgImg" /> An operative cannot perform this action while within control range of an operative, or if that breach point is open.</li>
        </ul>
        <p><em>The elite operatives that form kill teams are specially equipped to overcome all manner of barriers. Some draw upon esoteric traits and adaptable skills to inventively force a route to their target. From point-blank firepower and atomic destabilisers to bio-acids and raw strength fuelled by faith, operatives have a variety of methods at their disposal to breach weak points. The forces involved can result in extreme damage, with whizzing debris and violent shock waves hitting those unlucky enough to be on the other side.</em></p>
        <figure>
            <img src="./src/img/tw-breachpoint-1.png" className="imgGraphic" />
            <div>Closed</div>
        ...
        <figure>
            <img src="./src/img/tw-breachpoint-2.png" className="imgGraphic" />
            <div>Open</div>
        ...
        <figure>
            <img src="./src/img/tw-teleport_pad-1.png" className="imgGraphic" />
        </figure>
        ...
        <p>This is Light terrain.</p>
        <figure>
            <img src="./src/img/tw-lightrubble-example-1.png" className="imgGraphic" />
        </figure>
