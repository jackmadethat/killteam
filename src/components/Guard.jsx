function Guard() {
  return (
    <div className="sectionContent" id="guard">
        ...
        <ul>
            <li>
                <img src="./src/img/yes.svg" className="svgImg" /> The operative is on guard (see below) until any of the following are true:
                <ul>
            ...
            <li>
                <img src="./src/img/no.svg" className="svgImg" /> This action is treated as a <b>Shoot</b> action. An operative cannot perform this action while it has a Conceal order, or while it’s within control range of an enemy operative.
            </li>
        </ul>
