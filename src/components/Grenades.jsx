function Grenades() {
  return (
    <div className="sectionContent" id="grenades">
        ...
        <p>1AP</p>
        <ul>
            <li><img src="./src/img/yes.svg" className="svgImg" /> Place one of your smoke grenade markers within 6" of this operative. It must be visible to this operative or set on vantage terrain or a terrain feature visible to this operative. The marker creates a 1" horizontally and vertically unlimited smoke area from it (but not below it).</li>
            <li><img src="./src/img/yes.svg" className="svgImg" /> While an operative is wholly within a smoke area, it is considered obscured to operatives more than 2" away from it and vice versa. Additionally, when an operative shoots at an enemy operative that is wholly within a smoke area, the Piercing rule is ignored unless both operatives are within 2" of each other.</li>
            <li><img src="./src/img/yes.svg" className="svgImg" /> In the Ready Step of the next Strategy Phase, roll a D3. Remove that smoke grenade marker once a number of activations equal to the result of that D3 is completed, or at the end of the turning point (whichever occurs first).</li>
            <li><img src="./src/img/no.svg" className="svgImg" /> An operative cannot perform this action while within the control range of an enemy operative, or if the total number of times your kill team can perform it has been reached.</li>
        </ul>
        <figure>
            <img src="./src/img/utilitygrenades-example-1.png" className="imgGraphic" />
        </figure>
        <p>STUN GRENADE</p>
        <p>1AP</p>
        <ul>
            <li><img src="./src/img/yes.svg" className="svgImg" />Select an enemy operative within 6" of this operative and visible to it. That operative and each other operative within 1" of it makes a stun check. To make a stun check, roll a D6: if the result is 3+, subtract 1 from its APL stat until the end of its next activation.</li>
            <li><img src="./src/img/no.svg" className="svgImg" />An operative cannot perform this action while within control range of an enemy operative, or if you have reached the total number of times your kill team can perform it.</li>
        </ul>
        <figure>
            <img src="./src/img/utilitygrenades-example-2.png" className="imgGraphic" />
        </figure>
        ...
        <figure>
            <img src="./src/img/explosivegrenades-example-1.png" className="imgGraphic" />
        </figure>
        <table>
            <tbody>
                <tr>
        ...
        <figure>
            <img src="./src/img/explosivegrenades-example-2.png" className="imgGraphic" />
        </figure>
    </div>
  )
}
