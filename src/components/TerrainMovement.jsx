const TerrainMovement = () => {
  return (
      <div className="sectionContent" id="terrainMovement">
          ...
          <figure>
              <img src="https://raw.githubusercontent.com/jackmadethat/killteam/01bb60551df95996bfba75fb02c0b2a5baf61ff5/src/img/OperativeDiagram_Climb.svg" className="imgGraphic" />
