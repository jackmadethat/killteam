function TerrainMovement() {
  return (
      <div className="sectionContent" id="terrainMovement">
          ...
          <p><em>Agents must end a move in a location where they can be placed; they cannot end mid-climb, jump, or drop. If that is not possible, they cannot begin the move.</em></p>
          <h3>Climbing</h3>
          ...
          <p><em>Jumping means agents can move across gaps up to 4" wide and over things that are below them.</em></p>
          <figure>
              <img src="./src/img/jumping-1.png" className="imgGraphic" />
              ...
              <p><em>Remember that increments are rounded up, so if the operative moves 3.5”, this is treated as 4”</em></p>
          </figure>
          <figure>
              <img src="./src/img/jumping-2.png" className="imgGraphic" />
          ...
          <figure>
              <img src="./src/img/jumping-3.png" className="imgGraphic" />
