  ...
  return (
    <div className="sectionContent" id="universalActions">
        ...
        <div className="actionDiv">
            ...
            <ul>
                <li><img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/icons/yes.svg" className="svgImg" /> Place a 32mm marker in base-to-base contact with the active operative. Until the activation ends or it moves, this marker represents the location of the active operative for the purposes of line of sight, cover and distance considerations.</li>
        ...
        <figure>
            ...
            <p>Operative B can <b>Lean Out</b> in order to target Operative A.</p>
        </figure>
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_LeanOut_02.svg" className="imgGraphic diagramClipFix" />
            </div>
        ...
        <p className="indentNote"><em>Proper use of the <b>Lean Out</b> action can be game-changing. From staging ambushes to hit-and-run tactics and suppressing fire, working with corners can be the difference between life and death for operatives, and victory or defeat for a game.</em></p>
    </div>
  )
}
