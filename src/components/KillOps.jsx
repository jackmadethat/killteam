const KillOps = () => {
  return (
    <div className="sectionContent" id="killops">
      <p style={{ marginBottom: 40 + 'px' }}>The Kill Op awards each player VP for incapacitating enemy operatives, as detailed in the table below. This is always active for both players. Each player can score a maximum of 6VP total (for the entire game) from the Kill Op: up to 5 for incapacitating enemy operatives, plus a bonus VP for ending the game with a higher kill grade than the opponent. The Kill Op can be selected as a player's Primary Op.</p>
