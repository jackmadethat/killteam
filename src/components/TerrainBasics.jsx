function TerrainBasics() {
  return (
    <div className="sectionContent" id="terrainBasics">
        ...
        <figure>
            <img src="./src/img/terrain-heavy-1.png" className="imgGraphic" />
        ...
        <figure>
            <img src="./src/img/terrain-light-1.png" className="imgGraphic" />
        </figure>
        <figure>
            <img src="./src/img/terrain-light-2.png" className="imgGraphic" />
        </figure>
        <h3>Blocking</h3>
        ...
        <figure>
            <img src="./src/img/terrain-blocking-1.png" className="imgGraphic" />
        ...
        <figure>
            <img src="./src/img/terrain-blocking-2.png" className="imgGraphic" />
        ...
        <figure>
            <img src="./src/img/terrain-vantage-1.png" className="imgGraphic" />
            <em>
        ...
        <figure>
            <img src="./src/img/terrain-vantage-2.png" className="imgGraphic" alt="Vantage terrain" />
        ...
        <figure>
            <img src="./src/img/terrain-accessible-1.png" className="imgGraphic" alt="Accessible terrain" />
        ...
        <figure>
            <img src="./src/img/terrain-insignificant-1.png" className="imgGraphic" alt="Insignificant terrain" />
        ...
        <figure>
            <img src="./src/img/terrain-exposed-1.png" className="imgGraphic" alt="Exposed terrain" />
        ...
        <figure>
            <img src="./src/img/walls-example-1.png" className="imgGraphic" />
        ...
        <figure>
            <img src="./src/img/walls-example-2.png" className="imgGraphic" />
        ...
        <figure>
            <img src="./src/img/walls-example-3.png" className="imgGraphic" />
            <p>A corner of the wall is intervening, therefore operative B is in cover.</p>
        </figure>
        <figure>
            <img src="./src/img/walls-example-4.png" className="imgGraphic" />
        ...
        <figure>
            <img src="./src/img/walls-example-5.png" className="imgGraphic" />
            <p>An end of the wall is intervening, therefore operative B is in cover.</p>
        </figure>
        <figure>
            <img src="./src/img/walls-example-6.png" className="imgGraphic" />
