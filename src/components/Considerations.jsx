  ...
  return (
    <div className="sectionContent" id="considerations">
        ...
        <ul>
            ...
            <li><img src="./src/img/shoot.svg" className="svgImg" alt="Shoot" /> <img src="./src/img/attack.svg" className="svgImg" alt="Attack" /> <b>Weapon type:</b> <img src="./src/img/shoot.svg" className="svgImg" alt="Shoot" /> are ranged weapons for whenever an operative is shooting, <img src="./src/img/attack.svg" className="svgImg" alt="Attack" /> are melee weapons for whenever an operative is fighting or retaliating.</li>
