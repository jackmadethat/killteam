function KeyPrinciples() {
  return (
    <div classNameName="sectionContent" id="keyPrinciples">
        ...
        <h3>Orders</h3>
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/order-engage.png" className="imgGraphic" style={{ maxWidth: 100 + 'px', maxHeight: 100 + 'px' }} alt="Order" />
        <p><b>Engage: The operative can perform actions as normal and can counteract.</b></p>
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/order-conceal.png" className="imgGraphic" style={{ maxWidth: 100 + 'px', maxHeight: 100 + 'px' }} alt="Order" />
