function KeyPrinciples() {
  return (
    <div classNameName="sectionContent" id="keyPrinciples">
        <h3>Bases</h3>
        ...
        <p><em>As you play through your first few games, you’ll gain better context for applying key principles, and can simply refer back to them when needed.</em></p>
        <h3>Control Range</h3>
        ...
        <p><em>Imagine control range as an area of interaction the operative has with things close to it.</em></p>
        <figure>
            <img src="./src/img/control-range-1.png" className="imgGraphic" alt="Control Range Example" />
        ...
        <p><em>An operative in cover with a Conceal order is not a valid target. An operative in cover with an Engage order is a valid target, but has a cover save.</em></p>
        <figure>
            <img src="./src/img/cover-example-1.png" className="imgGraphic" alt="Cover Example" />
            <p>There’s intervening terrain within operative A’s control range, therefore it’s in cover.</p>
        </figure>
        <figure>
            <img src="./src/img/cover-example-2.png" className="imgGraphic" alt="Cover Example" />
            <p>There’s intervening terrain, but it’s not within operative A’s control range, therefore it’s not in cover.</p>
        </figure>
        <figure>
            <img src="./src/img/cover-example-3.png" className="imgGraphic" alt="Cover Example" />
            <p>There’s terrain within operative A’s control range, but the terrain is not intervening, therefore it’s not in cover.</p>
        </figure>
        <figure>
            <img src="./src/img/cover-example-4.png" className="imgGraphic" alt="Cover Example" />
        ...
        <p><em>Keep track of each operative’s remaining wounds with dice, tokens or by writing it down.</em></p>
        <p><em>‘Incapacitated’ and ‘removed from the killzone’ are separate. Some rules take effect when an operative is incapacitated, but before it’s removed.</em></p>
        <h3>Datacards</h3>
        ...
        <p><em>For example, if a 4+ is required, a dice result of 4, 5 or 6 fulfils this, and if a 1-4 is required, a dice result of 1, 2, 3 or 4 fulfils this.</em></p>
        <h3>Distances</h3>
        ...
        <p><em>Operatives within a certain distance of an operative that’s carrying a marker are also within the same distance of that marker.</em></p>
        <figure>
            <img src="./src/img/distances-example-1.png" className="imgGraphic" alt="Distance Example" />
        ...
        <p><em>The operative’s player decides from which point of the base targeting lines are drawn from. This can allow the operative to get a more favourable targeting angle — imagine the operative leaning right or left as appropriate.</em></p>
        <p><em>Intervening is usually determined from one operative to another, but some rare rules will require you to determine it from other things such as markers. In such instances, treat all parts of that thing as the ‘base’ when determining this.</em></p>
        <figure>
            <img src="./src/img/intervening-example-1.png" className="imgGraphic" alt="Intervening Example" />
            <p>Targeting lines cross terrain, therefore it’s intervening.</p>
        </figure>
        <figure>
            <img src="./src/img/intervening-example-2.png" className="imgGraphic" alt="Intervening Example" />
            <p>Due to where operative A’s player has decided to draw the targeting lines from, the terrain is not intervening.</p>
        </figure>
        <figure>
            <img src="./src/img/intervening-example-3.png" className="imgGraphic" alt="Intervening Example" />
        ...
        <p><em>Objective markers are the most common marker, representing vital locations in the killzone. Controlling them is often required to achieve victory.</em></p>
        <p><em>It’s fine to use a miniature to represent a marker, but have a normal marker available if it creates rules issues (e.g., it’s too big).</em></p>
        <figure>
            <img src="./src/img/markers-example-1.png" className="imgGraphic" alt="Markers Example" />
        ...
        <p><em>Obscured is when an operative is a valid target, but intervening obstacles (usually terrain) make it a less efficient target. Imagine the operative having to target the enemy through a ruin or distant window.</em></p>
        <figure className="figure">
            <img src="./src/img/obscured-example-1.png" className="imgGraphic" alt="Obscured Example" />
        ...
        <figure>
            <img src="./src/img/obscured-example-2.png" className="imgGraphic" alt="Obscured Example" />
            <p>There’s intervening Heavy terrain, but it’s within 1” of A, therefore operative B is not obscured.</p>
        </figure>
        <figure>
            <img src="./src/img/obscured-example-3.png" className="imgGraphic" alt="Obscured Example" />
            ...
            <p><em>In other words, an operative being within 1" of a terrain feature doesn’t prevent the whole terrain feature from being obscuring, only the part within 1" of the operative.</em></p>
        </figure>
        <h3>Operatives</h3>
        ...
        <h3>Orders</h3>
        <img src="./src/img/order-engage.png" className="imgGraphic" style="max-width: 100px; max-height: 100px;" alt="Order" />
        <p><b>Engage: The operative can perform actions as normal and can counteract.</b></p>
        <img src="./src/img/order-conceal.png" className="imgGraphic" style="max-width: 100px; max-height: 100px;" alt="Order" />
        ...
        <figure>
            <img src="./src/img/visible-example-1.png" className="imgGraphic" alt="Visible Example" /><p>Full visibility example.</p>
        </figure>
        <figure>
            <img src="./src/img/visible-example-2.png" className="imgGraphic" alt="Visible Example" /><p>Partial visibility example.</p>
        </figure>
