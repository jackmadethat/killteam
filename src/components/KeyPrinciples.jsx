const KeyPrinciples = () => {
  return (
    <div className="sectionContent" id="keyPrinciples">
        ...
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_ControlRange.svg" className="imgGraphic" />
        ...
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Cover_01.svg" className="imgGraphic" />
            <p>Operative B is in cover from operative A.</p>
        </figure>
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Cover_02.svg" className="imgGraphic" />
            <p>Operative B is not in cover from operative A.</p>
        </figure>

        <h3>Obscured</h3>
        <p>Obscurity is determined from one operative to another. An operative is obscured if there’s intervening Heavy terrain that’s more than 1” from both operatives. However, it cannot be obscured by intervening Heavy terrain that’s within 1” of either operative.</p>
        ...
        <figure className="figure">
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Obscurity_01.svg" className="imgGraphic" />
        ...
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Obscurity_02.svg" className="imgGraphic" />
        ...
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Obscurity_03.svg" className="imgGraphic" />
        ...
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Intervening_01.svg" className="imgGraphic" />
            <p>Targeting lines cross terrain even though they partially pass through a window, therefore the terrain is intervening.</p>
        </figure>
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Intervening_02.svg" className="imgGraphic" />
            <p>Due to where operative A’s player has decided to draw the targeting lines from, the terrain is not intervening.</p>
        </figure>
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Intervening_03.svg" className="imgGraphic" />
        ...
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Distances.svg" className="imgGraphic" />
        ...
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/Orders_Engage.svg" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px', marginLeft: 2 + '%' }} alt="Order" />
        ...
        <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/Orders_Conceal.svg" className="imgGraphic" style={{ maxWidth: 200 + 'px', maxHeight: 200 + 'px', marginLeft: 2 + '%' }} alt="Order" />
        ...
        <h3>Dice</h3>
        <p>Use 6-sided dice (d6) to determine the outcome of various rules. This will often require x+, where x is the lowest possible result, e.g., 3+. Sometimes a result within a range will be required, e.g., 1-3. Some rare rules require you to roll a d3. To do so, roll one d6 and halve the result (rounding up). Some require xd6 or xd3 (e.g., 2d6 or 3d3). Roll x number of dice and add the results together. Some require d6+x or d3+x (e.g., d6+2 or d3+3). Roll that dice and add x to the result.</p>
        ...
        <figure>
            <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Markers.svg" className="imgGraphic" />
