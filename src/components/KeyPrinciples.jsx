    ...
    <div className="sectionContent" id="keyPrinciples">
        ...
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_ControlRange.svg" className="imgGraphic diagramClipFix" />
            </div>
        ...
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Cover_01.svg" className="imgGraphic diagramClipFix" />
            </div>
            <p>Operative B is in cover from operative A.</p>
        </figure>
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Cover_02.svg" className="imgGraphic diagramClipFix" />
            </div>
        ...
        <figure className="figure">
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Obscurity_01.svg" className="imgGraphic diagramClipFix" />
            </div>
        ...
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Obscurity_02.svg" className="imgGraphic diagramClipFix" />
            </div>
        ...
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Obscurity_03.svg" className="imgGraphic diagramClipFix" />
            </div>
        ...
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Intervening_01.svg" className="imgGraphic diagramClipFix" />
            </div>
            <p>Targeting lines cross terrain even though they partially pass through a window, therefore the terrain is intervening.</p>
        </figure>
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Intervening_02.svg" className="imgGraphic diagramClipFix" />
            </div>
            <p>Due to where operative A’s player has decided to draw the targeting lines from, the terrain is not intervening.</p>
        </figure>
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Intervening_03.svg" className="imgGraphic diagramClipFix" />
            </div>
        ...
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Distances.svg" className="imgGraphic diagramClipFix" />
            </div>
        ...
        <figure>
            <div className="diagramDiv">
                <img src="https://raw.githubusercontent.com/jackmadethat/killteam/refs/heads/main/src/img/operativediagrams/OperativeDiagram_Markers.svg" className="imgGraphic diagramClipFix" />
            </div>
