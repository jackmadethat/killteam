...
const MapsOctarius = () => {
  return (
    <div className="sectionContent" id="gallowdark">
      <p>In the Killzones of Octarius, teams of specialist soldiers skirmish between ramshackle Ork structures. These ferrous heaps are hammered together with reckless abandon by the teeming Ork hordes. Crude fortifications and staging posts built in places of strategic importance, they create a warren of cover and elevated platforms where death can approach from unexpected angles.</p>
      <br />
      <MapsKey />
